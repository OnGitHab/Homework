class GroupFullError(Exception):
    def __init__(self, massage="Досягнена максимальна кількість студентів у групі. Неможливо додати студентів"):
...
class Group:
    ...
    def __str__(self):
        all_students = f"\n".join(str(student) for student in self.students_info)
